    ...
    if len(text)>7:
        ...
        for msg in messages:
            ...
            try:
                ...
                pass
        await message.reply_text(text=f"<b>❗️ <u>IMPORTANT</u> ❗️</b>\n\nThis video / file will be deleted in 1 minute (Due to copyright issues).\n\n📌 Please forward this video / file to somewhere else and start downloading there.", parse_mode = ParseMode.HTML)
